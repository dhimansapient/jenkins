...
--tag-specifications ResourceType=instance,Tags=[{Key=Name,Value=Ec2-Instance-Launched-via-Jenkins}] ResourceType=volume,Tags=[{Key=Name,Value=Ec2-Instance-Launched-via-Jenkins}]
